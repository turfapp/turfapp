...
@section('form')
    <form id="login" class="ta:form" aria-live="assertive" accept-charset="UTF-8" method="post" action="{{ route('auth.login') }}">
        ...
        <div class="ta:form-group">
            ...
            <input id="account_email_field" type="email" name="email" autocomplete="off" autocapitalize="none" aria-required="true" required="required" spellcheck="false" placeholder="{{ __('E-Mail Address') }}" autofocus="autofocus" />
