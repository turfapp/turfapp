...
/**
 * Class BalanceIncrement
 *
 * This event is fired whenever a member's balance is incremented.
 *
 * @package App\Events
 */
class BalanceIncrement extends BalanceUpdate
{
    use Dispatchable;
