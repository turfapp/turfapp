 ...
 * - "userdel"
 */
class TurfLogsUserAdd extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $this->alterEnum('turf_logs', 'turf_log_type', ['increment', 'decrement', 'useradd', 'userleave', 'userdel']);
    }
    ...
    public function down()
    {
        DB::transaction(function() {
            TurfLog::where('turf_log_type', 'useradd')->orWhere('turf_log_type', 'userleave')->orWhere('turf_log_type', 'userdel')->delete();
            $this->alterEnum('turf_logs', 'turf_log_type', ['increment', 'decrement']);
        });
    }
