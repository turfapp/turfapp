...
class TurfLogsPromoteUser extends Migration
{
    ...
    public function down()
    {
        DB::transaction(function() {
            TurfLog::where('turf_log_type', 'userpromote')->delete();
            $this->alterEnum('turf_logs', 'turf_log_type', ['increment', 'decrement', 'useradd', 'userleave', 'userdel', 'updatesettings', 'creategroup', 'userreset']);
        });
    }
