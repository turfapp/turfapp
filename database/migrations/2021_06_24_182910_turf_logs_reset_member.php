...
class TurfLogsResetMember extends Migration
{
    ...
    public function down()
    {
        DB::transaction(function() {
            TurfLog::where('turf_log_type', 'userreset')->delete();
            $this->alterEnum('turf_logs', 'turf_log_type', ['increment', 'decrement', 'useradd', 'userleave', 'userdel', 'updatesettings', 'creategroup']);
        });
    }
