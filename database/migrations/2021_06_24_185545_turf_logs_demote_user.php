...
class TurfLogsDemoteUser extends Migration
{
    ...
    public function up()
    {
        $this->alterEnum('turf_logs', 'turf_log_type', ['increment', 'decrement', 'useradd', 'userleave', 'userdel', 'updatesettings', 'creategroup', 'userreset', 'userpromote', 'userdemote']);
    }
    ...
    public function down()
    {
        DB::transaction(function() {
            TurfLog::where('turf_log_type', 'userdemote')->delete();
            $this->alterEnum('turf_logs', 'turf_log_type', ['increment', 'decrement', 'useradd', 'userleave', 'userdel', 'updatesettings', 'creategroup', 'userreset', 'userpromote']);
        });
    }
