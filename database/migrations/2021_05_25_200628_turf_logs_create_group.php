...
class TurfLogsCreateGroup extends Migration
{
    ...
    public function down()
    {
        DB::transaction(function() {
            TurfLog::where('turf_log_type', 'creategroup')->delete();
            $this->alterEnum('turf_logs', 'turf_log_type', ['increment', 'decrement', 'useradd', 'userleave', 'userdel', 'updatesettings']);
        });
    }
